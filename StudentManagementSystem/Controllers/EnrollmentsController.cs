...
namespace StudentManagementSystem.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,CourseID,StudentID,EnrolementDate")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentID,CourseID,StudentID,EnrolementDate")] Enrollment enrollment)
        {
